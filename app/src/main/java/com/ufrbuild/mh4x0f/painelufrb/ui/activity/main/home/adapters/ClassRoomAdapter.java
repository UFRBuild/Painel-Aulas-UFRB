...
public class ClassRoomAdapter extends RecyclerView.Adapter<ClassRoomAdapter.ViewHolder> implements Filterable {
    ...
    public interface OnClassRoomAdapter{
        void onClassRoomClicked(Discipline discipline);
    }

    private List<Discipline> mItems;
    private List<Discipline> mItemsFull;
    private OnClassRoomAdapter mListener;

    public ClassRoomAdapter(OnClassRoomAdapter listener) {
        mListener = listener;
...
//                    "<td>"+statusToString(data.result[i].status)+
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            mListener.onClassRoomClicked((Discipline) view.getTag());
        }
    }
}
