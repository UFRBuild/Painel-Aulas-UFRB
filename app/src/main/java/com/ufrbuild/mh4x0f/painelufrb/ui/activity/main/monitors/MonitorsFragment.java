...
public class MonitorsFragment  extends BaseFragment<MonitorsViewModel>
        implements ClassRoomAdapter.OnClassRoomAdapter{


    @Inject
    ViewModelProvider.Factory factory;
    private MonitorsViewModel viewModel;


    private String TAG = "MonitorsFragment";
    ClassRoomAdapter ClassRoomAdapter;

    @BindView(R.id.recycler_view_monitors)
    RecyclerView recyclerView;

    @BindView(R.id.progress_bar_monitors)
    ProgressBar progressBar;

    @BindView(R.id.empty_view_monitors)
    ConstraintLayout emptyView;

    @BindView(R.id.image_state)
    ImageView mImageState;

    @BindView(R.id.title_states_monitors)
    TextView mTitleStates;

    @BindView(R.id.subtitle_states_monitors)
    TextView mSubTitleStates;


    @BindView(R.id.floatingButtonAction_monitors)
    ...
    @BindView(R.id.swipe_refresh_monitors)
    ...
    @Override
    public MonitorsViewModel getViewModel() {
        viewModel = ViewModelProviders.of(this, factory).get(MonitorsViewModel.class);
        return viewModel;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView =  inflater.inflate(R.layout.fragment_monitors, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        viewModel.getLoadingStatus().observe(this, new MonitorsFragment.LoadingObserver());
        viewModel.getNetworkErrorStatus().observe(this, new MonitorsFragment.NetworkObserver());
        viewModel.getIsEmptyViewStatus().observe(this, new MonitorsFragment.EmptyViewObserver());
        viewModel.getDisciplines().observe(this, new MonitorsFragment.MovieObserver());
