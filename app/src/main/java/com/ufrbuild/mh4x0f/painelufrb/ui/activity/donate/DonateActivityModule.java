...
@Module
public class DonateActivityModule {
    @Provides
    DonateViewModel providesViewModel(DataManager store){
        return new DonateViewModel(store);
    }

    @Provides
    ViewModelProvider.Factory provideViewModelProvider(DonateViewModel viewModel){
